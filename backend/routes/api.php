...
Route::prefix('v1/public')->group(function () {
    ...
    Route::get('/page-content', [PageSectionController::class, 'public']);
});
...
Route::prefix('v1/admin')->middleware('auth:sanctum')->group(function () {
    ...
    Route::get('page-content', [PageSectionController::class, 'index']);
    Route::get('page-content/{key}', [PageSectionController::class, 'show']);
    Route::put('page-content/{key}', [PageSectionController::class, 'update']);
});
